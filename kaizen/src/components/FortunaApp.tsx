...
function Fortuna({ onLock }: { onLock: () => void }) {
  ...
  const tabs: TabDef[] = [
    ...
    { id: 'cashflow', label: 'Flow', icon: <AppIcon name="cashflow" size={20} />, render: () => <CashFlowTab {...props} /> },
    { id: 'portfolio', label: 'Assets', icon: <AppIcon name="portfolio" size={20} />, render: () => <PortfolioTab {...props} /> },
